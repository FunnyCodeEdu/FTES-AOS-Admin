...
- [ ] 1.3 Quality loop tính năng API layer: unit test (key/enabled, invalidate sau toggle,
...
- [ ] 2.3 Quality loop tính năng bảng kho: unit test (render cột, filter type/visibility,
...
- [ ] 3.3 Quality loop tính năng wizard-từ-kho: unit test (create mang courseId, attach
      ...
      → cột lesson cập nhật) → đánh giá vòng 1 → fix → đánh giá vòng 2
...
- [ ] 4.2 Quality loop tính năng toggle: unit test (ma trận enable/disable theo
