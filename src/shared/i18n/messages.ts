...
export const messages: Record<SupportedLang, Record<string, string>> = {
  vi: {
    ...
    "lesson.editor.saving": "Đang lưu…",
    "lesson.editor.emptyContent": "Nội dung bài học không được để trống.",
    "lesson.editor.challengeGenerate": "Sinh challenge (AI)",
    "lesson.editor.savedAt": "Đã lưu lúc {time}",
    "lesson.editor.staleConflict": "Bài này vừa được sửa ở nơi khác — tải lại trước khi lưu tiếp",
  ...
  en: {
    ...
    "lesson.editor.saving": "Saving…",
    "lesson.editor.emptyContent": "Lesson content cannot be empty.",
    "lesson.editor.challengeGenerate": "Generate challenge (AI)",
    "lesson.editor.savedAt": "Saved at {time}",
    "lesson.editor.staleConflict": "This lesson was just edited elsewhere — reload before saving again",
    "lesson.editor.source": "Source markdown",
    "lesson.editor.preview": "Preview",
